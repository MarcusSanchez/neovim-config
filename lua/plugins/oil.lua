-- Oil is BENCHED (2026-08-13) — back to the snacks explorer sidebar + tabs;
-- see snacks.lua/bufferline.lua. Uncomment the spec below to try the
-- buffer-as-filesystem workflow again.
--
